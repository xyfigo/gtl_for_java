...
public class GeomSuits {
    ...
    public static LabeledInterval createLabeledInterval(
            IntervalType t, double low, double high, String label,
            long pid,long order){
        return new LabeledInterval(t,  low,  high,  label,pid,order);
    }

    public static LabeledInterval createLabeledInterval(
            int t, double low, double high, String label,
            long pid,long order){
        return new LabeledInterval(IntervalType.values()[t],  low,  high,  label,pid,order);
    }
    ...
    public static Timeline createTimeline(Identifier identifier, List<LabeledInterval> li){
