...
public class TITree <T extends Interval> extends TDTree<T> {
    ...
    void leftExtension( ) {
        ...
        newMap.put("111", CommonSuits.createIdentifier(-1L));
        //6.insert empty leaf node BKG
        newMap.put("10", CommonSuits.createIdentifier(-1L));
    ...
    void rightExtension( ) {
        ...
        newMap.put("100", CommonSuits.createIdentifier(-1L));
        //6.insert empty leaf node CDE
        newMap.put("11", CommonSuits.createIdentifier(-1L));
        //7. reset the leafInfos
        leafInfos = newMap;
    }
