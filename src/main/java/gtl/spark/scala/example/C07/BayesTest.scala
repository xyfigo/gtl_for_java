...
object BayesTest {
  def main(args: Array[String]) {
    ...
    //val file = MLUtils.loadLabeledPoints(sc, "D:\\devs\\3rdparties\\spark\\spark-2.2.1\\data\\mllib\\sample_libsvm_data.txt") //读取数据集
    val file = sc.textFile("D:\\devs\\3rdparties\\spark\\spark-2.2.1\\data\\mllib\\sample_libsvm_data.txt") //读取数据集
